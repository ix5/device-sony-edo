...
# kernel dts qcom/kona.dtsi /dev/block/platform/soc/1d84000.ufshc/by-name/vendor
# Seine doesn't require this though...
#BOARD_KERNEL_CMDLINE += androidboot.bootdevice=1d84000.ufshc
#BOARD_KERNEL_CMDLINE += swiotlb=2048
BOARD_KERNEL_CMDLINE += service_locator.enable=1
# Also needed for edo? Both kumano and seine require Angelo's hack
